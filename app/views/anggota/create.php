            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="<?= BASEURL ?>/anggota/store" method="POST">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="id_anggota">ID Anggota</label>
                                    <input type="text" name="id_anggota" id="id_anggota" class="form-control" placeholder="A003">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="alamat" id="alamat" class="form-control" placeholder="Alamat (Opsional)" maxlength="50"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="no_hp">No. Handphone</label>
                                    <input type="tel" name="no_hp" class="form-control" id="no_hp" placeholder="0812-9000-9000" pattern="[0-9]{4}-[0-9]{4}-[0-9]{4}">
                                </div>
                            </div>
                            <!-- /.card-body -->
